...
def test_registration_form():
    open_form()
    app.StudentRegistrationForm.first_name("Alyona")
    app.StudentRegistrationForm.last_name("Tch")
    app.StudentRegistrationForm.email("verypyc@gmail.com")
    app.StudentRegistrationForm.gender("Female")
    app.StudentRegistrationForm.number("9998889988")
    app.StudentRegistrationForm.date_birth("27 July 1992")
    app.StudentRegistrationForm.subjects("Maths, English")
    app.StudentRegistrationForm.hobbies("Read")
    app.StudentRegistrationForm.picture("pepe.png")
    app.StudentRegistrationForm.address("Moscow")
    app.StudentRegistrationForm.states("NCR")
    app.StudentRegistrationForm.cities("Gurgaon")
